...
function register(event, handler, options) {
    return __awaiter(this, void 0, void 0, function () {
        var message, returnKey, returnMessage;
...
function unregister(event, key) {
    var message = message_1.makeMessage(types_1.XSysActions.Unregister, { event: event, key: key });
    var returnMessage = new Promise(function (resolve, reject) {
        var listener = function (e) {
...
function fire(event, data) {
    var message = message_1.makeMessage(types_1.XSysActions.Fire, { event: event, data: data });
    if (hasSW()) {
        navigator.serviceWorker.controller.postMessage(message);
    }
}
