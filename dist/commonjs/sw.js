...
self.createXEventSystem = function createXEventSystem(name) {
    return server_1.default(name);
};
// @ts-ignore - Assigning to the SW Global
self.createXEventSystem.VERSION = "1.5.2";
...
if (typeof localforage !== 'undefined' && typeof localforage.createInstance === 'function') {
    ...
    createInstance = __webpack_require__(6).createInstance;
}
var createSys = (function wrap(sw) {
    function broadcastToClients(message) {
        return __awaiter(this, void 0, void 0, function () {
            var clients;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, sw.clients.matchAll()];
                    case 1:
                        clients = _a.sent();
    ...
    return function createSys(name) {
        var store = createInstance({ name: name });
        function addEventListener(event, handler, options) {
            return __awaiter(this, void 0, void 0, function () {
                var register, key;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            key = options.key || helpers_1.randomKey();
        ...
        function listen() {
            var _this = this;
            sw.addEventListener('message', function (e) { return __awaiter(_this, void 0, void 0, function () {
                var message, _a, _b, event_1, handler, options, returnKey, key, _c, event_2, key, _d, event_3, data_1, register_1;
                var _e;
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        ...
                        case 1:
                            ...
                            if (!(returnKey && key)) return [3 /*break*/, 3];
                            return [4 /*yield*/, broadcastToClients((_e = { event: types_1.XSysEvents.Registered }, _e[returnKey] = key, _e))];
                        case 2:
                            _f.sent();
                            _f.label = 3;
                        ...
                        case 5:
                            ...
                            return [4 /*yield*/, broadcastToClients({ event: types_1.XSysEvents.Unregistered, key: key })];
                        case 6:
                            _f.sent();
                            _f.label = 7;
